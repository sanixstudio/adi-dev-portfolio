    ...
    return (
        <div className="previewpage bg-grey-darken">
            ...
            <main className="previewmain bg-grey">
                        ...
                        <div className="container mx-auto" >
                            <div className="herosection-content py-20 text-center" >
                                <h1 className="text-primary" >
                                    Bieber - React Personal Portfolio Template </h1> <p className="lead" >
                                    Bieber is a creative personal portfolio React template build with NextJS and TailwindCSS. </p> <ScrollLink activeClass="active"
                                        to="section-demos"
                                        spy={true}
                                        smooth="easeInQuad"
                                        offset={0}
                                    ...
                                    <span className="pl-2" > View Demos
                                    </span>
                                </ScrollLink>
                            </div>
                        </div>
                ...
                { /* Start demos section */} <Section name="section-demos"
                    className="demos-section py-24 lg:py-28 xl:py-32" >
                    <div className="container mx-auto" >
                        <SectionHeading title="Demos"
                            watermark="Demos" />
                        <div className="grid grid-cols-1 gap-10 md:grid-cols-2" > {
                            pages.map((page) => (<div className="col-span-1"
                                key={page.id} >
                                <Link href={page.path} >
                                    <a className="card hovercard block overflow-hidden" >
                                        <div className="imagebox overflow-hidden rounded" >
                                            <Image loader={imageLoader}
                                                ...
                                                width={650}
                                                alt={page.title}
                                            /> </div> <h5 className="py-3 text-center" > {page.title}
                                        </h5>
                                    </a>
                                </Link>
                            </div>
            ...
            </main> <footer className="footer bg-grey-darken" >
                <div className="contianer mx-auto" >
                    <p className="mb-0 py-4 text-center" >
                        &copy; {new Date().getFullYear()}, All right reserved <Link href="/" >
